-- Post-onboarding seed for local development
-- Applies after seed.sql — skips onboarding and loads a realistic data set
-- Usage: psql $DATABASE_URL -f supabase/seed_post_onboarding.sql
...
INSERT INTO public.budget_periods (id, user_id, start_date, end_date, income_target, fixed_target, flex_target, savings_target, income_stream_id) VALUES
  ('cccccccc-cccc-cccc-cccc-cccccccc0001', '00000000-0000-0000-0000-000000000000', CURRENT_DATE - INTERVAL '14 days', CURRENT_DATE + INTERVAL '14 days', 2800.00, 1700.00, 600.00, 500.00, 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbb0001')
ON CONFLICT DO NOTHING;
